...
**If time** add a shiny demo showing what happens to ANOVA table with two sliders,
one to adjust the amount of interaction (if any) and the other anything in the
main effects.
