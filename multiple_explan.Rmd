...
the resulting graph, and ANOVA table from the linear model. **Note**: as a slight
randomisation is used in changing the data, you will not obtain exactly the 
same data points for any given setting of the sliders. However, they will be
roughly similar.
...
Squares" or "Type III SS", which adjust for the order in which you enter the 
 ...
 * If there are big differences, consider using Type III. You can enable these
...
# Note capital A in Anova to access the Type III version.
